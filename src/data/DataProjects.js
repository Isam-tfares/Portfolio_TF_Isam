import BusProject from '../assets/BusProject.png';
import EspaceEtudiant from '../assets/EspaceEtudiant.png';
import WeatherProject from '../assets/WeatherProject.png';
import Classification from '../assets/classification_potato.png';
import BlogProject from '../assets/BlogProject.png';
import ASL from '../assets/ASL.jpg';
const DataProjects = [
    { id: '1', src: BusProject, title: 'Bus Timing', desc: 'React js,Bootstrap', view: 'https://isam-tfares.github.io/BusTemplate/', code: 'https://github.com/Isam-tfares/BusTemplate' },
    { id: '2', src: EspaceEtudiant, title: 'Student Area', desc: 'HTML5,CSS3,JS,PHP,MySQL', view: 'https://github.com/Isam-tfares/School-management', code: 'https://github.com/Isam-tfares/School-management' },
